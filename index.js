(async()=>{
    ...
    s4d.client.on('messageCreate', async (s4dmessage) => {
      ...
      if (command == '!ping') {
        ...
        S4D_APP_PKG_axios({
            ...
            s4dmessage.channel.send({content:String('DuinoCoin Wallet Verified!')});
          } else {
            s4dmessage.channel.send({content:String('Please enter a valid DuinoCoin Wallet.')});
          }
    ...
    const claim = new Database('./faucet.json')
    return s4d
})();
